...
impl<'a> RynkService<'a> {
    pub(crate) async fn handle_get_macro(&self, msg: &mut RynkMessage<'_>) -> Result<(), RynkError> {
        ...
        msg.write_response(&MacroData { data })
    }

    pub(crate) async fn handle_set_macro(&self, msg: &mut RynkMessage<'_>) -> Result<(), RynkError> {
